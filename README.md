...
This is a basic leaderboad app with a unique feature of consuming data from an API.
...
2. Clone this repo in your terminal or git bash using the command
   ...
   ```
   git@github.com:John-Kibirige/Leaderboard.git
   ```
...
Feel free to check the [issues page](https://github.com/John-Kibirige/Leaderboard/issues).
